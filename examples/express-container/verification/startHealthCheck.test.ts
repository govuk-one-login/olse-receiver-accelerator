...
process.env[ConfigurationKeys.VERIFICATION_ENDPOINT_URL] = "https://gds.co.uk/verify";
...
describe("startHealthCheck", () => {
  ...
  it("returns true when scheduling succeeds", () => {
    ...
    expect(loggerInfoSpy).toHaveBeenCalledWith("Verification signals scheduled sucessfully");
  });
});
