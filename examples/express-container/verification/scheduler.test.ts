...
describe('startVerificationSignals', () => {
    const mockSendVerificationSignal = sendVerificationSignal as jest.MockedFunction<typeof sendVerificationSignal>
    ...
    it('returns true when scheduling succeeds', () => {
        ...
        expect(consoleLogSpy).toHaveBeenCalledWith('Verification signals scheduled sucessfully');
    });
})