...
# To run this, you will need to create a personal access token with read:repo permissions in github and pass it as the env variable `GITHUB_TOKEN`
...
fileList=$(ls .github/workflows/*.yml)
